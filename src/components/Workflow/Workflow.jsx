...
const Workflow = () => {
  return (
    <div className="hero bg-[linear-gradient(to_right,#4F39F6,#9514FA)] h-auto p-5">
  <div className="hero-content text-center">
    <div className="md:max-w-155">
      <h1 className="text-2xl md:text-4xl font-bold text-white">Ready to Transform Your Workflow?</h1>
      <p className="py-6">
